package com.space.server.domain.item.presentation;
...
import com.space.server.domain.item.presentation.dto.response.ItemResponse;
import com.space.server.domain.item.service.QueryItemService;
